...
namespace App\Services\Ofertas;
...
class OfertaVehiculoService
{
    ...
    public function getQuery($fields, OfertaVehiculo $query)
    {

        foreach ((new OfertaVehiculo())->getColumnsName() as $column) {
