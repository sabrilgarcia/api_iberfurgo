...
use App\Services\Proveedor\TipoProveedorService;
use Exception;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;
use Models\Proveedor\TipoProveedor;

class TipoProveedorController extends ApiController
{

    public function __construct()
    {
        $this->defaultService = new TipoProveedorService();
        parent::__construct();
    }
    ...
    {
        try {
            $ticket = TipoProveedor::findOrFail($id);
