...
class CombustibleService
{
    ...
    public function getQuery($fields, Combustible $query)
    {
        foreach ((new Combustible())->getColumnsName() as $column) {
