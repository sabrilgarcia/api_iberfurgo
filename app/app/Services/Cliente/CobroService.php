...
class CobroService
{
    public function get($fields)
    {
        ...
        return $query->with('Delegacion', 'FormaPago', 'Banco', 'Factura.Cliente')->get();
    }
    ...
    public function getQuery($fields, Cobro $query)
    {
        foreach ((new Cobro())->getColumnsName() as $column) {
