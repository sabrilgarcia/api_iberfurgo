...
class TipoProveedorService
{
    ...
    public function getQuery($fields, TipoProveedor $query)
    {
        foreach ((new TipoProveedor())->getColumnsName() as $column) {
