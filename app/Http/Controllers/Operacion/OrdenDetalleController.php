...
use App\Services\Operacion\OrdenDetalleService;
use Exception;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;
use Models\Operacion\OrdenDetalle;

class OrdenDetalleController extends ApiController
{

    public function __construct()
    {
        $this->defaultService = new OrdenDetalleService();
    ...
    {
        try {
            $ordenFactura = OrdenDetalle::with('vehiculo')->findOrFail($id);
