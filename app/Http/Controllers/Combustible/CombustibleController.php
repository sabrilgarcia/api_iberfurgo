...
use App\Services\Combustible\CombustibleService;
...
class CombustibleController extends ApiController
{

    public function __construct()
    {
        $this->defaultService = new CombustibleService();
        parent::__construct();
    }
    ...
    {
        try {
            $ticket = Combustible::findOrFail($id);
