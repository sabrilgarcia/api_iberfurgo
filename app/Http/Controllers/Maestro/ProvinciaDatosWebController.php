...
use App\Services\Maestro\ProvinciaDatosWebService;
...
class ProvinciaDatosWebController extends ApiController
{
    public function __construct()
    {
        $this->defaultService = new ProvinciaDatosWebService();
    ...
    {
        try {
            $modulo = ProvinciaDatosWeb::with('Provincia')->findOrFail($id);
