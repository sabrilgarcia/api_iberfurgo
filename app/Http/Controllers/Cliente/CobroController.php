...
use App\Services\Cliente\CobroService;
use Exception;
...
class CobroController extends ApiController
{
    ...
    {
        $this->defaultService = new CobroService();
    ...
    {
        try {
            $cobro = Cobro::with('Delegacion','FormaPago','Banco', 'Factura.Cliente')->findOrFail($id);
            
            return $this->respond(['data' => $cobro]);
