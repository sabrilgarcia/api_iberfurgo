...
namespace App\Http\Controllers\Franquicia;

use App\Http\Controllers\ApiController;
use App\Services\Franquicia\FranquiciaContratoService;
...
class FranquiciaContratoController extends ApiController
{

    public function __construct()
    {
        $this->defaultService = new FranquiciaContratoService();
        parent::__construct();
    }
    ...
    {
        try {
            $ticket = FranquiciaContrato::findOrFail($id);
