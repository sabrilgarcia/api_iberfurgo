...
use App\Services\Operacion\OrdenItemService;
use Exception;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Http\Request;
use Models\Operacion\OrdenItem;

class OrdenItemController extends ApiController
{

    public function __construct()
    {
        $this->defaultService = new OrdenItemService();
    ...
    {
        try {
            $ordenFactura = OrdenItem::findOrFail($id);
